...
about naming:
java_XX_YY_ZZZ_ violate java naming conventions, CamelCase. I know it.
java_XX_YY_ZZZ_ isn't really a part of lesson's (class's) name.

Manual:
1 Open CONSOLE.txt and keep it open (console output, all the logs)
3 Open any java_XX_YY_ZZZ_Name.java example 
